...
const form = document.getElementsByName('generalfrm');
...
form.addEventListener('submit', async event => {
  ...
  try {
    const res = await fetch(
      'http://http://ec2-43-205-214-206.ap-south-1.compute.amazonaws.com:3000/email/send',
      {
        method: 'POST',
        body: {
            "message": "This is from form"
        },
      },
    );
